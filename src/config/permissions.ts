...
export const ROUTE_PERMISSIONS = {
  DASHBOARD: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.VOLUNTEER],
  PROFILE: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.VOLUNTEER],
  VOLUNTEERS: [ROLES.COORDINATOR],
  ACTIVITIES: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.VOLUNTEER],
  HOURS: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.VOLUNTEER],
  RESOURCES: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.VOLUNTEER, ROLES.ADMIN],
  NOTIFICATIONS: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER, ROLES.VOLUNTEER, ROLES.ADMIN],
  SETTINGS: [ROLES.COORDINATOR],
  PROJECTS: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
} as const;
...
export const PERMISSIONS = {
  ...
  CREATE_ACTIVITY: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  EDIT_ACTIVITY: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  DELETE_ACTIVITY: [ROLES.COORDINATOR, ROLES.PROJECT_MANAGER],
  ...
  EDIT_OWN_HOURS: [ROLES.VOLUNTEER, ROLES.PROJECT_MANAGER],
  ...
  RECEIVE_NOTIFICATIONS: [ROLES.COORDINATOR, ROLES.VOLUNTEER, ROLES.PROJECT_MANAGER],
  
  // Perfil
  VIEW_OWN_PROFILE: [ROLES.COORDINATOR, ROLES.VOLUNTEER, ROLES.PROJECT_MANAGER],
  EDIT_OWN_PROFILE: [ROLES.COORDINATOR, ROLES.VOLUNTEER, ROLES.PROJECT_MANAGER],
