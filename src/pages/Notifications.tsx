...
const mockNotifications = [
  {
    ...
    message:
      'The system will be updated tonight from 2:00 AM to 4:00 AM. Some features may be temporarily unavailable.',
    type: 'info',
    recipient: 'everyone',
    sender: 'System Admin',
  ...
  },
  {
    ...
    message:
      'Join us for a community cleanup event this Saturday at Central Park. Volunteers needed!',
    type: 'event',
    recipient: 'everyone',
    sender: 'Maria Garcia',
  ...
  },
  {
    ...
    message:
      'Your submitted hours for last week are pending approval. Please check with your coordinator.',
    type: 'warning',
    recipient: 'specific',
  ...
  },
  {
    ...
    message:
      'Welcome to our volunteer management system. Please complete your profile setup.',
    type: 'success',
    recipient: 'specific',
...
const Notifications = () => {
  ...
  const handleCreateNotification = () => {
    ...
    const notification = {
      ...
      recipientUsers:
        newNotification.recipient === 'specific'
          ? newNotification.selectedUsers.map(
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewNotification((prev) => ({
                        ...
                        selectedUsers:
                          value === 'everyone' ? [] : prev.selectedUsers,
                      }))
                    }
                  >
                    <SelectTrigger>
                        ...
                        <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                          ...
                          {notification.recipientUsers && (
                            <>
                              <span>•</span>
                              <span>
                                To: {notification.recipientUsers.join(', ')}
                              </span>
                            </>
                          )}
                        </div>
